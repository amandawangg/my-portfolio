            ...
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7}> 
                        ...
                        <button onClick={() => window.open('https://drive.google.com/file/d/1DW6H2psQqxLDkLBNDY5ur0wvQzrSgpF9/view?usp=sharing', '_blank')}>View Resume <ArrowRightCircle size={25}/></button>
                    </Col>
                    <Col xs={12} md={6} xl={5}> 
